...
const drag = (e, op) => {
  ...
  if (event.button === 0) {
    ...
    let x = op.windowElement.offsetLeft - op.xOffset;
    let y = op.windowElement.offsetTop - op.yOffset;
...
const addDragEventListeners = (target, updateWindowPosition) => {
  target.addEventListener("mousedown", (e) => {
    ...
    if (windowTitle !== null) {
      ...
      titleDrag(e, (windowElement, _windowX, _windowY) => updateWindowPosition(target, windowElement, _windowX, _windowY));
    }
  });
}
